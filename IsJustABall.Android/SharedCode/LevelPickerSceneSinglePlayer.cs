				...
				if (hit) {
					...
					case "tutorial":
						...
						if (Math.Abs (templocation.Y - locationInverted.Y) <= 5.0f) {
							OnePlayerScrollerScene gameScene = new OnePlayerScrollerScene (mainWindowAux, LevelItem.Name,1);
					...
					case "railgun":
						//LevelItem.ScaleTo (new CCSize (LevelItem.ScaledContentSize.Width / 1.1f, LevelItem.ScaledContentSize.Height / 1.1f));
						if (Math.Abs (templocation.Y - locationInverted.Y) <= 5.0f) {
							OnePlayerScrollerScene gameScene2 = new OnePlayerScrollerScene (mainWindowAux, LevelItem.Name,1);
					...
					case "minefield":
						//LevelItem.ScaleTo (new CCSize (LevelItem.ScaledContentSize.Width / 1.1f, LevelItem.ScaledContentSize.Height / 1.1f));
						if (Math.Abs (templocation.Y - locationInverted.Y) <= 5.0f) {
							OnePlayerScrollerScene gameScene3 = new OnePlayerScrollerScene (mainWindowAux, LevelItem.Name,1);
					...
					case "blackhole":
						//LevelItem.ScaleTo (new CCSize (LevelItem.ScaledContentSize.Width / 1.1f, LevelItem.ScaledContentSize.Height / 1.1f));
						if (Math.Abs (templocation.Y - locationInverted.Y) <= 5.0f) {
							OnePlayerScrollerScene gameScene4 = new OnePlayerScrollerScene (mainWindowAux, LevelItem.Name,1);
					...
					case "testgrounds":
						...
						if (Math.Abs (templocation.Y - locationInverted.Y) <= 1) {
							OnePlayerScrollerScene gameScene5 = new OnePlayerScrollerScene (mainWindowAux, LevelItem.Name,1);
