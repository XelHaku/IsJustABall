...
namespace IsJustABall.Android
{
	public class TriangleClass
	{
		...
		public  List<TriangleCoordinates> RedTriangleMaker()
		{
			...
			GENERALList.Add ( new TriangleCoordinates {  V1X =0f,V1Y = 0f,V2X =0.1f,V2Y =0.1f,V3X =0.2f,V3Y = 0.2f  });
			...
			GENERALList.Add ( new TriangleCoordinates {  V1X =0.4f,V1Y = 0.2f,V2X =0.5f,V2Y =0.3f,V3X =0.4f,V3Y = 0.6f  });
			...
			GENERALList.Add ( new TriangleCoordinates {  V1X =0.2f,V1Y = 0.4f,V2X =0.2f,V2Y =0.6f,V3X =0.3f,V3Y = 0.5f  });
			...
			GENERALList.Add ( new TriangleCoordinates {  V1X =1f,V1Y = 1.6f,V2X =0.9f,V2Y =1.7f,V3X =0.8f,V3Y = 1.8f  });
			...
			GENERALList.Add ( new TriangleCoordinates {  V1X =0.6f,V1Y = 1.8f,V2X =0.5f,V2Y =1.9f,V3X =0.6f,V3Y = 2.2f  });
			...
			GENERALList.Add ( new TriangleCoordinates {  V1X =0.8f,V1Y = 2f,V2X =0.8f,V2Y =2.2f,V3X =0.7f,V3Y = 2.1f  });
		...
		{
			List<TriangleCoordinates> GENERALList = new List<TriangleCoordinates>();
			GENERALList.Add ( new TriangleCoordinates {  V1X =0f,V1Y = 0.1f,V2X =0.2f,V2Y =0.1f,V3X =0.2f,V3Y = 0.1f  });
			...
			GENERALList.Add ( new TriangleCoordinates {  V1X =0.8f,V1Y = 0.7f,V2X =0.7f,V2Y =0.6f,V3X =1f,V3Y = 0.7f  });
			...
			GENERALList.Add ( new TriangleCoordinates {  V1X =1f,V1Y = 1.7f,V2X =0.8f,V2Y =1.7f,V3X =0.8f,V3Y = 1.7f  });
			...
			GENERALList.Add ( new TriangleCoordinates {  V1X =0.2f,V1Y = 2.3f,V2X =0.3f,V2Y =2.2f,V3X =0f,V3Y = 2.3f  });
		...
		public  List<TriangleCoordinates> PurpleTriangleMaker()
		{
			...
			GENERALList.Add ( new TriangleCoordinates {  V1X =0.2f,V1Y = 0.8f,V2X =0.3f,V2Y =0.9f,V3X =0.3f,V3Y = 0.8f  });
			...
			GENERALList.Add ( new TriangleCoordinates {  V1X =0.8f,V1Y = 2.4f,V2X =0.7f,V2Y =2.5f,V3X =0.7f,V3Y = 2.4f  });
